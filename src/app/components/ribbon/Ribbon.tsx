...
const Ribbon: React.FC<RibbonProps> = ({ ribbonText, altText }) => {
  return (
    <figure className='relative flex justify-center items-center text-center'>
      ...
      <h2 className='absolute bottom-0 left-0 right-0 text-white font-lily-script text-3xl md:text-4xl lg:text-5xl xl:text-6xl mt-5 md:mt-10 lg:mt-20'>{ribbonText}</h2>
    </figure>
  );
}
