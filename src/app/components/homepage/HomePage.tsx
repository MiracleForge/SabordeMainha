...
const HomePage = () => {
  return (
    <>
        <section className='grid grid-cols-3 w-full justify-center items-center text-center font-lily-script pt-10'>
        <Link href={'/errors/Error404'} className='w-3/5 h-auto mx-44 rounded-3xl backdrop-blur-md bg-primary shadow-inner shadow-fontColor2 text-center group '>
        ...
        <Link href={'/errors/Error404'} className='w-3/4 h-auto rounded-3xl mx-32 backdrop-blur-md bg-linebaseColor/90 shadow-inner shadow-fontColor2 text-center group '>
          <div className=' m-2 border-2 border-white rounded-3xl flex flex-col items-center gap-3 relative'>
        ...
        <Link href={'/errors/Error404'} className='w-3/5 h-auto rounded-3xl mx-32 backdrop-blur-md bg-primary shadow-inner shadow-fontColor2 text-center group '>
          <div className=' m-2 border-2 border-white rounded-3xl flex flex-col items-center gap-3 relative'>
          ...
          <div className='h-screen w-full bg-cookieMain bg-cookieMain-small md:bg-cookieMain-medium lg:bg-cookieMain-large mt-20 bg-repeat-space'>
